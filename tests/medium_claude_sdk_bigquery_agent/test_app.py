...
from medium_claude_sdk_bigquery_agent.app import app
...
async def test_app_lifespan():
    from medium_claude_sdk_bigquery_agent.app import lifespan

    mock_fastapi_app = MagicMock()

    with (
        patch(
            "medium_claude_sdk_bigquery_agent.app.BigQueryAdapter"
        ) as mock_adapter_cls,
        patch("medium_claude_sdk_bigquery_agent.app.AgentService") as mock_service_cls,
        patch(
            "medium_claude_sdk_bigquery_agent.app.get_schema",
